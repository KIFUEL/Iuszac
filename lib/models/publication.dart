...
class Publication {
  ...
  factory Publication.fromJson(Map<String, dynamic> json) {
    return Publication(
      ...
      eventStart: json['event_start'] != null ? DateTime.parse(json['event_start']).toLocal() : null,
      eventEnd: json['event_end'] != null ? DateTime.parse(json['event_end']).toLocal() : null,
      ...
      featuredUntil: json['featured_until'] != null ? DateTime.parse(json['featured_until']).toLocal() : null,
      issuingBody: json['issuing_body'],
      entryIntoForce: json['entry_into_force'] != null ? DateTime.parse(json['entry_into_force']).toLocal() : null,
